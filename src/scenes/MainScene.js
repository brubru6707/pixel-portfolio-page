...
export default class MainScene extends Phaser.Scene {
    ...
    update() {
        ...
        // Player Movement
        if (isLikelyMobileDevice() && !pointingAtKey && this.mobilePlayerMove)  {
        ...
        // Axe positioning
        let desktopAxeActivationReq = (downF.isDown || this.activateAxe) && !isLikelyMobileDevice()
        let mobileAxeActivationReq = this.activateAxe && isLikelyMobileDevice() && this.mobilePlayerMove
